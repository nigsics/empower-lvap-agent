...
rates_default_0 :: TransmissionPolicy(MCS "2 4 11 22 12 18 24 36 48 72 96 108", HT_MCS "");
...
reg_1 :: EmpowerRegmon(EL el, IFACE_ID 1, DEBUGFS /sys/kernel/debug/ieee80211/phy1/regmon);
rates_default_1 :: TransmissionPolicy(MCS "2 4 11 22 12 18 24 36 48 72 96 108", HT_MCS "");
...
ipClassifier1 :: IPClassifier(
		dst udp port 7007  or dst udp port 7008,
		-
	);


ipRewriter :: IPRewriter(
		pattern - -          192.168.0.20  - 0 0, // UE -> GW
...
ipClassifier1[0] -> ipRewriter -> kt;
ipClassifier1[1] -> kt;


ipClassifier2[0] -> ipRewriter -> tee;
ipClassifier2[1] -> tee;


                                                                                      
ctrl :: Socket(TCP, 192.168.0.20, 4433, CLIENT true, VERBOSE true, RECONNECT_CALL el.reconnect)
    -> el :: EmpowerLVAPManager(WTP 00:0D:B9:2F:56:B4,                                         
                                EBS ebs,                                                       
                                EAUTHR eauthr,                                                 
                                EASSOR eassor,                                                 
                                EDEAUTHR edeauthr,                                             
                                E11K e11k,                                                     
                                RES " 04:F0:21:09:F9:9B/1/20 D4:CA:6D:14:C2:0F/6/20",          
